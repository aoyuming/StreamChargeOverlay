...
internal static class SingleExeLauncher
{
    ...
    private const string AppFolderName = "DNF\u8D5E\u52A9\u7CFB\u7EDF-win32-x64";
    private const string AppExeName = "DNF\u8D5E\u52A9\u7CFB\u7EDF.exe";
    ...
    )
    {
        ...
        string zipPath = Path.Combine(installRoot, "streamcharge-desktop.zip");
